        ...
        <Reveal delay={250}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap bg-transparent border-2 border-white text-white hover:bg-white/10 font-bold px-10 py-4 text-base rounded-md transition-colors"
            >
              미생물 추천받기
